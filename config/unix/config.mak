...
$(CONFIG_H): $(CONFIG2_SH) $(CONFIG2_C)
	...
	$(CFLAGS) $(CONFIG_CFLAGS) $(STDOPT) $(STDINCL) $(UUIDLIBS) $(CFLIBS) $(SOCKLIBS) $(STDLIB) $(CONFIG_TAIL)
...
$(CONFIG_HPP): $(CONFIG2_SH) $(CONFIG2_CPP)
	...
	CC="$(CXX)" \
	"$(CONFIG2_SH)" $(CONFIG_HEAD) \
	$(CXXFLAGS) $(CONFIG_CXXFLAGS) $(STDOPTXX) $(STDINCL) $(UUIDLIBS) $(SOCKLIBS) $(STDLIBXX) $(CONFIG_TAIL)
