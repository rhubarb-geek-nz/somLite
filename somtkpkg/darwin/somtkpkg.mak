...
LINKRPATH=-Wl,-rpath,/Library/Frameworks/SOMTK.framework/Versions/$(FRAMEWORK_VERS)/PlugIns
...
$(BINDIR)/irdump: $(IRDUMP_OBJS)
	$(CC) $(IRDUMP_OBJS) $(CFLAGS) -o $@ $(STDLIB) -F$(FRAMEWORKS) -F$(SUBFRAMEWORKS) -framework SOMTK $(LINKRPATH)

$(BINDIR)/somdd: $(SOMDD_OBJS)
	$(CC) $(SOMDD_OBJS) $(CFLAGS) -o $@ $(STDLIB) -F$(FRAMEWORKS) -F$(SUBFRAMEWORKS) -framework SOMTK $(UUIDLIBS) $(LINKRPATH)

$(BINDIR)/somossvr: $(SOMOSSVR_OBJS)
	$(CXX) $(SOMOSSVR_OBJS) $(CXXFLAGS) -o $@ $(STDLIB) -F$(FRAMEWORKS) -F$(SUBFRAMEWORKS) -framework SOMTK $(UUIDLIBS) $(LINKRPATH)

$(BINDIR)/somdsvr: $(SOMDSVR_OBJS)
	$(CXX) $(SOMDSVR_OBJS) $(CXXFLAGS) -o $@ $(STDLIB) -F$(FRAMEWORKS) -F$(SUBFRAMEWORKS) -framework SOMTK $(UUIDLIBS) $(LINKRPATH)

$(BINDIR)/somdchk: $(SOMDCHK_OBJS)
	$(CXX) $(SOMDCHK_OBJS) $(CFLAGS) -o $@ $(STDLIB) -F$(FRAMEWORKS) -F$(SUBFRAMEWORKS) -framework SOMTK $(UUIDLIBS) $(LINKRPATH)

$(BINDIR)/regimpl: $(REGIMPL_OBJS)
	$(CC) $(REGIMPL_OBJS) $(CFLAGS) -o $@ $(STDLIB) -F$(FRAMEWORKS) -F$(SUBFRAMEWORKS) -framework SOMTK $(UUIDLIBS) $(LINKRPATH)

$(BINDIR)/dsom: $(DSOM_OBJS)
	$(CC) $(DSOM_OBJS) $(CFLAGS) -o $@ $(STDLIB) -F$(FRAMEWORKS) -F$(SUBFRAMEWORKS) -framework SOMTK $(UUIDLIBS) $(LINKRPATH)
