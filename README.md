...
The dependency on [rhbtools](https://rhbtools.sf.net) has been removed and PowerShell is used in Windows builds for tasks such as build order determination and `config.h` generation.
